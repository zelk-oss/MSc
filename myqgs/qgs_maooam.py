...
# import the classes for the different types of objects in the model 
# these are used to re-build real fields 
...
if __name__ == "__main__":
    ...
    """
    multiplying dt and write_steps one gets how often data points are written down. 

    one time unit corresponds to roughly 0.11 days. 
    The time is made adimensional in the model using the Coriolis parameter (f_0)

    dt*write_steps = 10 ==> 1 data point = 1.1 days roughly 

    Integrating for 1e6 time units and writi
    """
