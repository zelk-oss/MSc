...
def run_process(file_name):
    ...
    accelerate = 1
    file_path = '../../../data_thesis/data_1e5points_1000ws/window_for_TE/fast_slow_dynamics/'
...
run_process('fast_TE_timeseries_strong_0avg')
run_process('slow_TE_timeseries_strong_0avg')