...
def plot_te_results():
    k1, te12_alg1, std12_alg1, te21_alg1, std21_alg1 = load_te_file("te_mu1_results_alg1.txt")
    #k2, te12_alg2, std12_alg2, te21_alg2, std21_alg2 = load_te_file("te_mu1_results_alg2.txt")
