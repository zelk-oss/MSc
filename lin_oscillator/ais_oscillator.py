...
def compute_AIS_over_range(file_path, max_k=15, out_file="ais_results_mu1.txt"):
    if not isJVMStarted():
    ...
    dataRaw = np.loadtxt(file_path, skiprows=1)
...
if __name__ == "__main__":
    file_path = "/home/chiaraz/thesis/lin_oscillator/data_lin_oscillator/data_mu1.txt"
